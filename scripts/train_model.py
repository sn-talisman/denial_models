...
Usage:
    python scripts/train_model.py --days-back 180 --limit 1000 --model-type lightgbm
"""
...
async def main():
    ...
    parser.add_argument("--days-back", type=int, default=180, help="Days of historical data")
